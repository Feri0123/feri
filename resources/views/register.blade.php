...
border-secondary form-control-lg"
name="email"><br>
<div class="form-group mt-1">
...
border border-secondary form-control-lg"
name="password">
</div><br>
<div class="form-group mt-1">
...
primary mt-5">Register</button>
</form>
<p class="mt-2 text-center">Sudah punya akun? <a
href="{{ route('auth.login') }}" style="text-decoration: none">Ayo
masuk!</a></p>
</div>
</div>
</div>
